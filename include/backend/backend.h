...
namespace backend {
  ...
  public:
    ...
    static void printDevices() {
      std::println(std::cout, "======================= Detected Devices =======================");
      for (const auto& registry = BackendRegistry::instance(); const auto& provider : registry.getProviders()) {
        ...
        switch (provider->getBackendType()) {
          ...
          case Device::CPU: {
            ...
            std::println(std::cout, "  Device Name:       {}", backend::CpuBackendProvider::getCpuName());
            std::println(std::cout, "  Physical Cores:    {}", backend::CpuBackendProvider::getPhysicalCores());
            std::println(std::cout, "  Logical Threads:   {}", backend::CpuBackendProvider::getThreadCount());
    ...
    [[nodiscard]] const BackendInfo* getDevice(const Device dev, const size_t device_id) const {
